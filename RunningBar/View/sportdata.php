            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="box box-primary">
                        <div class="box-body">
                            <img width="80%" height="80%" class="center-block img-responsive img-circle" src="common/assets/img/avatar.png">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-4 col-md-2">
                                    <img src="common/assets/img/medal1.png" style="width: 80%">
                                </div>
                                <div class="col-sm-4 col-md-2">
                                    <img src="common/assets/img/medal1.png" style="width: 80%">
                                </div>
                                ...
                                <div class="col-sm-4 col-md-2">
                                    <img src="common/assets/img/medal2.png" style="width: 80%">
                                </div>
                                <div class="col-sm-4 col-md-2">
                                    <img src="common/assets/img/medal2.png" style="width: 80%">
                                </div>
                                ...
                                <div class="col-sm-4 col-md-2">
                                    <img src="common/assets/img/medal3.png" style="width: 80%">
                                </div>
                            </div>
                        </div>
                    </div>
